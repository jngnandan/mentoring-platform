  ...
  return (
    // <section className="relative py-20 bg-gradient-to-b from-black-300 to-white">
      ...
      <Tabs value={activeTab} onChange={setActiveTab} className="mb-8 flex justify-center max-w-[165px] mx-auto">          <Tabs.List>
        ...
        {activeTab === 'mentee' && (
          <div className="text-center">
            ...
            <Group justify="center" className="mt-8">
              <Button component={Link} to="/mentors" size="lg" variant="outline" color="gray">
                View Mentors
              </Button>
              <Button component={Link} to="/about" size="lg">
                Know More
              </Button>
            </Group>
          </div>
        ...
        <Text size="sm" className="text-center mt-12 text-gray-500 mt-4">
